...
class Ui_Widget(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.spinBoxSearchPages.setProperty("value", 30)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditResultSaveFile.setText(_translate("MainWindow", 'C:/Users/' + os.environ['USERNAME'] + r'/Downloads/GoogleScholar/Results.xlxs'))
        ...
        self.lineEditSearchContent.setText(_translate("MainWindow", ""))
    ...
    def selectResultSaveFile(self):
        ...
        if fileName=="":
            self.lineEditResultSaveFile.setText(r'C:/Users/' + os.environ['USERNAME'] + r'/Downloads/GoogleScholar/Results.xlxs')
